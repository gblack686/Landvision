...
from bokeh.models import (CategoricalColorMapper, HoverTool, GMapOptions, WheelZoomTool, NumberFormatter,
						  ColumnDataSource, TabPanel, Tabs, Span, NumeralTickFormatter, HTMLTemplateFormatter, DateFormatter,
						  FuncTickFormatter, SingleIntervalTicker, LinearAxis)

from bokeh.models.widgets import (CheckboxGroup, Slider, RangeSlider, Button,
								  CheckboxButtonGroup, MultiSelect,
...
# Create plots and attributes
    p = figure(height=500, width=800, title="Competitive Market Area")
    ...
    pmap = gmap(Google_API, map_options, width=360, height=400, title="CMA Map", toolbar_location="above")
...
# Create layout
    ...
    tab = TabPanel(child = l, title = 'Scattergraph')
